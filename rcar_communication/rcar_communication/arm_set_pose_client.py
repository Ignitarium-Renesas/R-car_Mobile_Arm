...
class ArmSetPoseClient(Node):
    def __init__(self):
        super().__init__('arm_set_pose_client')
    ...
    def send_request(self, base_pose):
        ...
        # Call the service
        future = self.arm_set_pose_client.call_async(request)
